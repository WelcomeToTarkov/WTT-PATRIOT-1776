...
class WTTPatriot1776 {
    ...
    displayCreditBanner() {
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.RED);
        this.Instance.logger.log(`[${this.modName}] Pre-Alpha development build`, LogTextColor_1.LogTextColor.RED);
        this.Instance.logger.log(`[${this.modName}] Developers:Tron and the WTT Team`, LogTextColor_1.LogTextColor.WHITE);
        this.Instance.logger.log(`[${this.modName}]  Democracy in the form of 5.56 NATO`, LogTextColor_1.LogTextColor.BLUE);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.BLUE);
    }
}
